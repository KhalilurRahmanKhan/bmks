        ...
        <div class="row ">
            <div class="col-3 sidebar text-center">
                ...
                <ul class="list-unstyled " style="width:70% ;margin:auto;">
                    ...
                    <li class="py-1 px-3 bg-primary m-1 text-white" style="padding:5px;"><a class="text-white text-decoration-none" href="{{url('notice')}}">Notice</a></li>
                    <li class="py-1 px-3 bg-primary m-1 text-white" style="padding:5px;"><a class="text-white text-decoration-none" href="{{url('slider')}}">Slider</a></li>
                    <button class="dropdown-btn py-1 px-3  bg-primary m-1 text-white " style="padding:5px; width:100%;border:none;">Projects
                        <i class="fa fa-caret-down"></i>
                    </button>
                    <div class="dropdown-container">
                        <p style="margin: 1px auto; width:75%; background-color: #3280f4;color: white;border-radius: 5px;"><a href="{{url('project')}}" class="drop-item" href="#">View</a></p>
                        <p style="margin: 1px auto; width:75%;background-color: #3280f4;color: white;border-radius: 5px;"><a href="{{url('project/create')}}" class="drop-item" href="#">Create</a></p>
                    </div>
